...
public class Messages {
    ...
    public static final String MESSAGE_EMPTY_ADDRESS_BOOK = "Current address book is empty. This might be due to corrupted data."
        + "\nWARNING: Please check if data/addressbook.json has old corrupted data and if so, attempt to fix it, otherwise any new commands will overwrite those contents.";
